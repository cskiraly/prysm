...
func (p *PubSub) handleSendingMessages(ctx context.Context, s network.Stream, outgoing *rpcQueue, firstMessage chan *RPC) {
	writeRpc := func(rpc *RPC) error {
		...
		wt := time.Now()
		_, err = s.Write(out)
		outgoing.noteWrite(time.Since(wt))
		if err != nil {
